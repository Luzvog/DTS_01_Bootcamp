/*    
Inicio Homework
Ítem 1) Inserte los siguientes registros dentro de la base de datos creada 
en la clase anterior, corregir los errores que impidan la instrucción.
*/
...
/*    
Ítem 2) No se sabe con certeza el lanzamiento de las cohortes N° 1245 y N° 1246, 
...
/*    
Ítem 3) Se ha decidido retrasar el comienzo de la cohorte N°1243, por lo que la nueva fecha de inicio será 
el 16/05. Se le solicita modificar la fecha de inicio de esos alumnos.
*/
...
/*    
Ítem 4) El alumno N° 165 solicito el cambio de su Apellido por “Ramirez”.
*/
...
/*    
Ítem 5) El área de Learning le solicita un listado de alumnos de la Cohorte N°1243 que incluya la 
fecha de ingreso.
*/
...
/*    
Ítem 6) Como parte de un programa de actualización, el área de People le solicita un listado de 
los instructores que dictan la carrera de Full Stack Developer.
*/

SELECT carrera.nombre, cohorte.codigo, cohorte.idInstructor, instructor.nombre, instructor.apellido
FROM carrera
INNER JOIN cohorte ON carrera.idCarrera = cohorte.idCarrera
INNER JOIN instructor ON cohorte.idInstructor = instructor.idInstructor
WHERE carrera.nombre = 'Full Stack Developer';

/*    
Ítem 7) Se desea saber que alumnos formaron parte de la cohorte N° 1235. Elabore un listado.
*/

SELECT cedulaIdentidad, nombre, apellido, idCohorte
FROM alumno
WHERE idCohorte = 1235;

/*    
Ítem 8) Del listado anterior se desea saber quienes ingresaron en el año 2019.
*/

SELECT cedulaIdentidad, nombre, apellido, fechaIngreso, idCohorte
FROM alumno
WHERE idCohorte = 1235 AND fechaIngreso BETWEEN '2019-01-01' AND '2019-12-31';